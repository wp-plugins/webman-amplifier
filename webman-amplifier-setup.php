 ...
 */
	 ...
	 */
		function wm_enable_webman_advanced_metabox() {
			return true;
		} // /wm_enable_webman_advanced_metabox

		/**
		 * Uncomment to enable WebMan Advanced Metaboxes
		 */
		// add_filter( 'wmhook_metabox_visual_wrapper_toggle', 'wm_enable_webman_advanced_metabox' );



	/**
	 * Don't use the plugin's shortcodes CSS stylesheet on frontend
	 */
		function wm_disable_frontend_shortcodes_css() {
			return true;
		} // /wm_disable_frontend_shortcodes_css

		/**
		 * Uncomment to disable plugin's frontend shortcodes styles
		 */
		// add_filter( 'wmhook_shortcode_enqueue_shortcode_css', 'wm_disable_frontend_shortcodes_css' );
 ...
 */
	 ...
	 */
		 ...
		 */
		function wm_additional_metafields( $fields = array() ) {
			...
			return $fields;
		} // /wm_additional_metafields

		/**
		 * Uncomment to add your custom post meta fields
		 */
		// add_filter( 'wmhook_wmamp_cp_metafields_wm_projects', 'wm_additional_metafields' );
 ...
 */
	if ( class_exists( 'WPBakeryVisualComposer' ) ) {
		...
		/**
		 * Uncomment to remove default Visual Composer elements
		 */
		// add_theme_support( 'webman-shortcodes', array( 'remove_vc_buttons' ) );
		 ...
		 */
			...
			//Comparing and altering the Visual Composer settings
				...
				if ( ! empty( $vc_post_types_diff ) ) {
					$vc_post_types_new = array_merge( (array) get_option( 'wpb_js_content_types' ), $vc_post_types_diff );
	 ...
	 */
	// add_action( 'wmhook_wmamp_plugin_activation', 'wm_add_vc_templates' );
 ...
 */
	 ...
	 */
	// add_filter( 'wmhook_icons_default_iconfont_css_url', 'wm_iconfont_css_url' );
	 ...
	 */
	function wm_iconfont_config_array() {
		$icons = array();

		$icons['icon_class'] = array( 'class' => 'icon_class', 'char' => 'character_used' );

		return $icons;
	} // /wm_iconfont_config_array

	/**
	 * Uncomment to set the custom default icons config array file path
	 */
	// add_filter( 'wmhook_icons_default_iconfont_config_array', 'wm_iconfont_config_array' );
