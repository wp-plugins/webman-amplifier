 ...
 */
	...
	//Define global constants
		...
		//Dark/light color brightness treshold for color functions [0,255]
			define( 'WMAMP_COLOR_TRESHOLD', 140 );
 ...
 * @since  1.0
 */
function wm_amplifier_activate() {
	do_action( WMAMP_HOOK_PREFIX . 'plugin_activation' );
} // /activate

register_activation_hook( WMAMP_PLUGIN_FILE, 'wm_amplifier_activate' );
