...
> **Before you rate the plugin**, please note that the plugin was created **for WordPress theme developers**. It is for no use to normal non-tech-savvy WordPress user. If you are a theme developer and have any issue with the plugin, please, consider rising a ticket at [WebMan Support Forum](http://support.webmandesign.eu/) first, before you rate the plugin.
