...
> **Before you rate the plugin**:
> Please note that the plugin was created **for WordPress theme developers**. If you are a normal, non-tech-savvy WordPress user, this plugin will be disappointing for you as it was created for different purpose.
