...
jQuery( function() {
	 ...
	 */
		...
		if ( jQuery().isotope ) {
			 ...
			 */
			$filteredContent.prev( '.wm-filter' ).on( 'click', 'a', function( e ) {
					e.preventDefault();
	 ...
	 */
		...
		if ( jQuery().masonry ) {
			...
			var $masonryThis = jQuery( '.masonry-this' );

			$masonryThis.imagesLoaded( function() {
				$masonryThis.masonry( {
