...
jQuery( function() {
	 ...
	 */
		...
		if ( jQuery().wpColorPicker ) {
			jQuery( '.wm-meta-wrap .color-wrap .fieldtype-text' ).wpColorPicker();
		}
	 ...
	 */
		...
		//Upload multiple images (gallery) action
			jQuery( '.wm-meta-wrap .gallery-wrap' ).on( 'click', '.button-set-gallery', function() {
	 ...
	 */
		...
		//Upload image action
			jQuery( '.wm-meta-wrap .image-wrap label, .wm-meta-wrap .button-set-image' ).on( 'click', function() {
	 ...
	 */
		...
		jQuery( '.wm-meta-wrap .confirm' ).on( 'click', function() {
	 ...
	 */
		...
		//Adding new cells (items)
			jQuery( '.wm-meta-wrap .button-add-cell' ).on( 'click', function() {
				var $this        = jQuery( this ),
		...
		//Removing existing cells (items)
			jQuery( '.wm-meta-wrap .button-remove-cell' ).on( 'click', function() {
				var $this        = jQuery( this ),
	 ...
	 */
		...
		//Upload ZIP file action
			jQuery( '.wm-meta-wrap .zip-wrap label, .wm-meta-wrap .zip-wrap .fieldtype-zip, .wm-meta-wrap .button-set-zip' ).on( 'click', function() {
				//Check if the wp.media.editor API exists.
					if ( typeof wp === 'undefined' || ! wp.media || ! wp.media.editor ) {
						return;
					}
