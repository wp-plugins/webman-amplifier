 ...
 */
	 ...
	 * @version     1.0
	 */
	if ( ! function_exists( 'wm_field_checkbox' ) ) {
		function wm_field_checkbox( $field, $page_template = null ) {
	...
	add_action( WM_METABOX_HOOK_PREFIX . 'render_' . 'checkbox', 'wm_field_checkbox', 10, 2 );
	 ...
	 * @version     1.0
	 */
	if ( ! function_exists( 'wm_field_checkbox_validation' ) ) {
		function wm_field_checkbox_validation( $new, $field, $post_id ) {
			$new = esc_attr( $new );

			return $new;
		} // /wm_field_checkbox_validation
	} // /function_exists check

	add_action( WM_METABOX_HOOK_PREFIX . 'saving_' . 'checkbox', 'wm_field_checkbox_validation', 10, 3 );
