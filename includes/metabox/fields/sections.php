 ...
 */
	 ...
	 * @version     1.0
	 */
	if ( ! function_exists( 'wm_field_section_open' ) ) {
		function wm_field_section_open( $field, $page_template = null ) {
		...
		} // /wm_field_section_open
	} // /function_exists check

	add_action( WM_METABOX_HOOK_PREFIX . 'render_' . 'section-open', 'wm_field_section_open', 10, 2 );
	 ...
	 * @version     1.0
	 */
	if ( ! function_exists( 'wm_field_section_close' ) ) {
		function wm_field_section_close( $field, $page_template = null ) {
			//Field definition array
				$field = wp_parse_args( (array) $field, array(
						//DEFAULTS:
						//* = Required setting
		...
		} // /wm_field_section_close
	} // /function_exists check

	add_action( WM_METABOX_HOOK_PREFIX . 'render_' . 'section-close', 'wm_field_section_close', 10, 2 );
 ...
 */
	 ...
	 * @version     1.0
	 */
	if ( ! function_exists( 'wm_field_sub_section_open' ) ) {
		function wm_field_sub_section_open( $field, $page_template = null ) {
			//Field definition array
				$field = wp_parse_args( (array) $field, array(
						//DEFAULTS:
						//* = Required setting
		...
		} // /wm_field_sub_section_open
	} // /function_exists check

	add_action( WM_METABOX_HOOK_PREFIX . 'render_' . 'sub-section-open', 'wm_field_sub_section_open', 10, 2 );
	 ...
	 * @version     1.0
	 */
	if ( ! function_exists( 'wm_field_sub_section_close' ) ) {
		function wm_field_sub_section_close( $field, $page_template = null ) {
			//Field definition array
				$field = wp_parse_args( (array) $field, array(
						//DEFAULTS:
						//* = Required setting
			...
			//Output
				...
				echo "\r\n\t" . '</tbody> <!-- /SUB-SECTION -->' . "\r\n\t" . '<tbody>';
		} // /wm_field_sub_section_close
	} // /function_exists check

	add_action( WM_METABOX_HOOK_PREFIX . 'render_' . 'sub-section-close', 'wm_field_sub_section_close', 10, 2 );
