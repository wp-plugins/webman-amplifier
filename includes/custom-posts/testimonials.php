 ...
 */
	//Actions
		//Registering CP
			add_action( WMAMP_HOOK_PREFIX . 'register_post_types', 'wm_testimonials_cp_register', 10 );
		//CP list table columns
			add_action( 'manage_wm_testimonials_posts_custom_column', 'wm_testimonials_cp_columns_render' );
		//Registering taxonomies
			add_action( WMAMP_HOOK_PREFIX . 'register_post_types', 'wm_testimonials_cp_taxonomies', 10 );
		//Permanlinks settings
			add_action( 'admin_init', 'wm_testimonials_cp_permalinks' );
	...
	//Filters
		//CP list table columns
			add_filter( 'manage_edit-wm_testimonials_columns', 'wm_testimonials_cp_columns_register' );
 ...
 */
	 ...
	 * @since  1.0
	 */
	if ( ! function_exists( 'wm_testimonials_cp_register' ) ) {
		function wm_testimonials_cp_register() {
 ...
 */
	 ...
	 * @since  1.0
	 */
	if ( ! function_exists( 'wm_testimonials_cp_columns_register' ) ) {
		function wm_testimonials_cp_columns_register( $columns ) {
			//Helper variables
				$prefix = 'wmamp-';
	...
	} // /wm_testimonials_cp_columns_register
	 ...
	 * @since  1.0
	 */
	if ( ! function_exists( 'wm_testimonials_cp_columns_render' ) ) {
		function wm_testimonials_cp_columns_render( $column ) {
			//Helper variables
				global $post;
				$prefix = 'wmamp-';
				$suffix = '-wm_testimonials';
	...
	} // /wm_testimonials_cp_columns_render
 ...
 */
	 ...
	 * @since  1.0
	 */
	if ( ! function_exists( 'wm_testimonials_cp_taxonomies' ) ) {
		function wm_testimonials_cp_taxonomies() {
			$permalinks = get_option( 'wmamp-permalinks' );
 ...
 */
	 ...
	 * @since  1.0
	 */
	if ( ! function_exists( 'wm_testimonials_cp_permalinks' ) ) {
		function wm_testimonials_cp_permalinks() {
			//Adding sections
				add_settings_section(
						'wmamp-' . 'wm_testimonials' . '-permalinks',
						__( 'Testimonials Custom Post Permalinks', 'wm_domain' ),
						'wm_testimonials_cp_permalinks_render_section',
						'permalink'
					);
	 ...
	 * @since  1.0
	 */
	if ( ! function_exists( 'wm_testimonials_cp_permalinks_render_section' ) ) {
		function wm_testimonials_cp_permalinks_render_section() {
			//Settings section description
				echo '<p>' . __( 'You can change the Testimonials custom post type permalinks here.', 'wm_domain' ) . '</p>';
		}
	} // /wm_testimonials_cp_permalinks_render_section
 ...
 */
	 ...
	 * @since  1.0
	 */
	if ( ! function_exists( 'wm_testimonials_cp_metafields' ) ) {
		function wm_testimonials_cp_metafields() {
			//Helper variables
				$fields = array();
	...
	if ( function_exists( 'wm_add_meta_box' ) ) {
		wm_add_meta_box( array(
				...
				'fields' => 'wm_testimonials_cp_metafields',
