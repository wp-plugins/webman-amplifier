...
//Validation
	...
	//caption
		$atts['caption'] = '<' . esc_attr( $atts['heading_tag'] ) . ' class="wm-price-caption wm-price-element">' . strip_tags( trim( $atts['caption'] ), $this->inline_tags ) . '</' . esc_attr( $atts['heading_tag'] ) . '>';
	//color
