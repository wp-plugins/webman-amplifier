 ...
 * Helpers:
	...
	VISUAL EDITOR STYLE DEFINITION:
		title [required]
...
//Helper variables
	...
	$wm_modules_slugs = wm_posts_array( 'post_name', 'wm_modules' );
	$wm_modules_tags  = wm_taxonomy_array( array(
			'all_post_type' => '',
			'all_text'      => '',
			'hierarchical'  => '0',
			'tax_name'      => 'module_tag'
		) );
	$wm_testimonials_slugs      = wm_posts_array( 'post_name', 'wm_testimonials' );
	$wm_testimonials_categories = wm_taxonomy_array( array(
			'all_post_type' => '',
			'all_text'      => '',
			'hierarchical'  => '0',
...
$shortcode_definitions = array(
	...
	//Accordions, tabs, toggles
		...
		'accordion' => array(
				...
				'generator'  => array(
						...
						'code'       => '[PREFIX_accordion active="0" behaviour="accordion/toggle" filter="0/1" class=""]<br />[PREFIX_item title="' . __( 'Section 1', 'wm_domain' ) . '" tags=""]{{content}}[/PREFIX_item]<br />[PREFIX_item title="' . __( 'Section 2', 'wm_domain' ) . '" tags=""]' . __( 'Section 2 content goes here', 'wm_domain' ) . '[/PREFIX_item]<br />[/PREFIX_accordion]',
						'vc_enabled' => false,
					),
				'vc_plugin'  => array(
		...
		'tabs' => array(
				...
				'generator'  => array(
						...
						'code'       => '[PREFIX_tabs active="0" layout="top/left/right" tour="0/1" class=""]<br />[PREFIX_item title="' . __( 'Tab 1', 'wm_domain' ) . '" tags=""]{{content}}[/PREFIX_item]<br />[PREFIX_item title="' . __( 'Tab 2', 'wm_domain' ) . '" tags=""]' . __( 'Tab 2 content goes here', 'wm_domain' ) . '[/PREFIX_item]<br />[/PREFIX_tabs]',
						'vc_enabled' => false,
					),
				'vc_plugin'  => array(
		...
		'item' => array(
				...
				'generator'  => array(
						...
						'code'       => '[PREFIX_item title="' . __( 'Title', 'wm_domain' ) . '" tags=""]{{content}}[/PREFIX_item]',
						'vc_enabled' => false,
					),
				'vc_plugin'  => array(
	...
	//Buttons
		...
		'button' => array(
				...
				'generator'  => array(
						...
						'code'       => '[PREFIX_button url="#" color="' . implode( '/', array_keys( self::$codes_globals['colors'] ) ) . '" size="' . implode( '/', array_keys( self::$codes_globals['sizes'] ) ) . '" icon="" class=""]{{content}}[/PREFIX_button]',
						'vc_enabled' => true,
					),
				'vc_plugin'  => array(
						...
						'params'   => array(
								...
								array(
									'heading'     => __( 'CSS ID', 'wm_domain' ),
									'type'        => 'textfield',
									'param_name'  => 'id',
									'value'       => '',
									'holder'      => 'hidden',
									'class'       => '',
									'description' => __( 'Optional CSS ID', 'wm_domain' )
								),
							)
					),
			),
	...
	//Call to action
		...
		'call_to_action' => array(
				...
				'generator'  => array(
						...
						'code'       => '[PREFIX_call_to_action caption="" button_text="" button_url="#" button_color="' . implode( '/', array_keys( self::$codes_globals['colors'] ) ) . '" button_size="' . implode( '/', array_keys( self::$codes_globals['sizes'] ) ) . '" button_icon="" class=""]{{content}}[/PREFIX_call_to_action]',
						'vc_enabled' => false,
					),
				'vc_plugin'  => array(
	...
	//Columns
		...
		'column' => array(
				...
				'generator'  => array(
						...
						'code'       => ( class_exists( 'WPBakeryVisualComposer' ) ) ? ( '[vc_column width="1/1,1/2,1/3,2/3,1/4,3/4,1/6,5/6" el_class=""]{{content}}[/vc_column]' ) : ( '[PREFIX_column width="' . implode( ',', self::$codes_globals['column_widths'] ) . '" last="0/1" class=""]{{content}}[/PREFIX_column]' ),
						'vc_enabled' => false,
					),
			),
	...
	//Countdown timer
		...
		'countdown_timer' => array(
				...
				'generator'  => array(
						...
						'code'       => '[PREFIX_countdown_timer time="' . date( get_option( 'date_format' ), strtotime( 'now' ) ) . '" size="' . implode( '/', array_keys( self::$codes_globals['sizes'] ) ) . '" class="" /]',
						'vc_enabled' => false,
					),
				'vc_plugin'  => array(
	...
	//Content Module
		...
		'content_module' => array(
				...
				'generator'          => array(
						...
						'code'       => '[PREFIX_content_module module="module-slug" align="left/right" columns="4" count="-1" order="new/old/name/random" tag="" filter="0/1" scroll="0" pagination="0/1" no_margin="0/1" layout="" class=""]{{content}}[/PREFIX_content_module]',
						'vc_enabled' => false,
					),
				'vc_plugin'          => array(
						...
						'params'   => array(
								...
								array(
									...
									'param_name'  => 'multiple',
									'value'       => array(
											__( 'Display multiple modules (leave the "Single module slug" option empty)', 'wm_domain' ) => 1,
										),
									'holder'      => 'hidden',
									'class'       => '',
								),
								...
								array(
									...
									'description' => sprintf( __( 'Set the custom layout of the output. Order the predefined items (%s) separated with comma (no spaces).', 'wm_domain' ), '<code>content,excerpt,image,morelink,tag,title</code>' ),
									'type'        => 'textfield',
									'param_name'  => 'layout',
									'value'       => '',
									'holder'      => 'hidden',
	...
	//Divider
		...
		'divider' => array(
				...
				'style'      => array(),
				'generator'  => array(
						'name' => __( 'Divider', 'wm_domain' ),
						'code' => '[PREFIX_divider type="' . implode( '/', array_keys( self::$codes_globals['divider_types'] ) ) . '" space_before="" space_after="" class="" /]',
						'vc_enabled' => true,
					),
				'vc_plugin'  => array(
						'name'                    => $this->prefix_shortcode_name . __( 'Divider', 'wm_domain' ),
	...
	//Dropcap
		...
		'dropcap' => array(
				...
				'generator'  => array(
						...
						'code' => '[PREFIX_dropcap color="' . implode( '/', array_keys( self::$codes_globals['colors'] ) ) . '" shape="' . implode( '/', array_keys( self::$codes_globals['dropcap_shapes'] ) ) . '" class=""]A[/PREFIX_dropcap]',
						'vc_enabled' => true,
					),
			),
	...
	//Icons
		...
		'icon' => array(
				...
				'generator'  => array(
						...
						'code'       => '[PREFIX_icon class="icon-class" social="' . implode( '/', $wm_social_icons_array ) . '" url="" size="" /]',
						'vc_enabled' => true,
					),
				'vc_plugin'  => array(
						...
						'params'   => array(
								...
								array(
									'heading'     => __( 'Social icon size', 'wm_domain' ),
	...
	//Marker
		...
		'marker' => array(
				...
				'generator'  => array(
						...
						'code' => '[PREFIX_marker color="' . implode( '/', array_keys( self::$codes_globals['colors'] ) ) . '" class=""]{{content}}[/PREFIX_marker]',
						'vc_enabled' => true,
					),
			),
	...
	//Messages
		...
		'message' => array(
				...
				'generator'  => array(
						...
						'code' => '[PREFIX_message title="" color="' . implode( '/', array_keys( self::$codes_globals['colors'] ) ) . '" size="' . implode( '/', array_keys( self::$codes_globals['sizes'] ) ) . '" icon="" class=""]{{content}}[/PREFIX_message]',
					),
				'vc_plugin'  => array(
	...
	//Posts / custom posts
		...
		'posts' => array(
				...
				'generator'  => array(
						...
						'code'       => '[PREFIX_posts post_type="' . implode( '/', array_keys( self::$codes_globals['post_types'] ) ) . '" align="left/right" columns="4" count="-1" order="new/old/name/random" taxonomy="taxonomy_name:taxonomy_slug" filter="taxonomy_name" scroll="0" pagination="0/1" related="0/1" no_margin="0/1" layout="" class=""]{{content}}[/PREFIX_posts]',
						'vc_enabled' => false,
					),
				'vc_plugin'  => array(
	...
	//Pricing table
		...
		'pricing_table' => array(
				...
				'generator'  => array(
						...
						'code'       => '[PREFIX_pricing_table no_margin="0/1" class=""]<br />[PREFIX_price title="' . __( 'Price 1', 'wm_domain' ) . '" tags=""]{{content}}[/PREFIX_price]<br />[PREFIX_price title="' . __( 'Price 2', 'wm_domain' ) . '" tags=""]' . __( 'Price 2 content goes here', 'wm_domain' ) . '[/PREFIX_price]<br />[/PREFIX_pricing_table]',
						'vc_enabled' => false,
					),
				'vc_plugin'  => array(
				...
				'vc_plugin'  => array(
						...
						'params'          => array(
								...
								array(
									...
									'type'        => 'textarea_html',
									'param_name'  => 'content',
									'value'       => __( '<ul><li>Price feature</li><li>Another price feature</li></ul>', 'wm_domain' ) . '[' . $this->prefix_shortcode . 'button url="#" color="' . implode( '/', array_keys( self::$codes_globals['colors'] ) ) . '" size="' . implode( '/', array_keys( self::$codes_globals['sizes'] ) ) . '" icon="" class=""]' . __( 'Button text', 'wm_domain' ) .'[/' . $this->prefix_shortcode . 'button]',
									'holder'      => 'hidden',
									'class'       => '',
								),
								array(
	...
	//Progress bar
		...
		'progress' => array(
				...
				'generator'  => array(
						...
						'code'       => '[PREFIX_progress color="' . implode( '/', array_keys( self::$codes_globals['colors'] ) ) . '" progress="75" class=""]{{content}}[/PREFIX_progress]',
						'vc_enabled' => false,
					),
				'vc_plugin'  => array(
	...
	//Pullquote
		...
		'pullquote' => array(
				...
				'generator'  => array(
						...
						'code' => '[PREFIX_pullquote align="' . implode( '/', array_keys( self::$codes_globals['align'] ) ) . '" class=""]{{content}}[/PREFIX_pullquote]',
						'vc_enabled' => true,
					),
			),
	...
	//Row
		...
		'row' => array(
				...
				'generator'  => array(
						...
						'code' => ( class_exists( 'WPBakeryVisualComposer' ) ) ? ( '[vc_row el_class=""]{{content}}[/vc_row]' ) : ( '[PREFIX_row class=""]{{content}}[/PREFIX_row]' ),
						'vc_enabled' => false,
					),
			),
				...
				'vc_plugin'  => array(
						...
						'params'   => array(
								...
								array(
									...
									'description' => __( 'One of WordPress predefined sizes:', 'wm_domain' ) . ' <code>full</code>, <code>' . implode( '</code>, <code>', get_intermediate_image_sizes() ) . '</code>',
									'type'        => 'textfield',
									'param_name'  => 'size',
									'value'       => apply_filters( WM_SHORTCODES_HOOK_PREFIX . 'slideshow_default_size', 'large' ),
									'holder'      => 'hidden',
									'class'       => '',
								),
								array(
									...
									'type'        => 'textfield',
									'param_name'  => 'speed',
									'value'       => apply_filters( WM_SHORTCODES_HOOK_PREFIX . 'slideshow_default_size', 3000 ),
									'holder'      => 'hidden',
									'class'       => '',
								),
								array(
	...
	//Table
		...
		'table' => array(
				...
				'generator'  => array(
						...
						'code'       => '[PREFIX_table type="' . implode( '/', array_keys( self::$codes_globals['table_types'] ) ) . '" separator="," class=""]{{content}}[/PREFIX_table]',
						'vc_enabled' => false,
					),
				'vc_plugin'  => array(
	...
	//Testimonials
		...
		'testimonials' => array(
				...
				'generator'          => array(
						...
						'code'       => '[PREFIX_testimonials testimonial="testimonial-slug" align="left/right" columns="4" count="-1" order="new/old/name/random" category="optional-category-slug" scroll="0" pagination="0/1" masonry="0/1" no_margin="0/1" class=""]{{content}}[/PREFIX_testimonials]',
						'vc_enabled' => false,
					),
				'vc_plugin'          => array(
						...
						'params'   => array(
								...
								array(
									...
									'param_name'  => 'multiple',
									'value'       => array(
											__( 'Display multiple testimonials (leave the "Single testimonial slug" option empty)', 'wm_domain' ) => 1,
										),
									'holder'      => 'hidden',
									'class'       => '',
								),
								...
								array(
									'heading'     => __( 'Masonry layout?', 'wm_domain' ),
									'description' => '',
									'type'        => 'dropdown',
									'param_name'  => 'masonry',
									'value'       => array(
	...
	//Widget area
		...
		'widget_area' => array(
				...
				'generator'  => array(
						...
						'code'       => '[PREFIX_widget_area area="' . implode( '/', array_keys( wm_widget_areas_array() ) ) . '" class="" max_widgets_count="0" /]',
						'vc_enabled' => true,
					),
				'vc_plugin'  => array(
						...
						'params'   => array(
								array(
									...
									'type'        => 'dropdown',
									'param_name'  => 'area',
									'value'       => array_flip( wm_widget_areas_array() ),
									'holder'      => 'div',
									'class'       => '',
								),
								array(
				...
				'vc_plugin'  => array(
					...
					'params'   => array(
							array(
								...
								'type'        => 'dropdown',
								'param_name'  => 'id',
								'value'       => array_flip( wm_posts_array( 'post_name', 'soliloquy' ) ),
								'holder'      => 'hidden',
								'class'       => '',
							),
						)
